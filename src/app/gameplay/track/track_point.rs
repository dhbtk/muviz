...
impl TrackPoint {
    pub fn lerp(&self, other: &Self, t: f32) -> Self {
        Self {
            ...
            is_above_other_track: self.is_above_other_track
                || (t > 0.5 && other.is_above_other_track),
        }
    }
    ...
    pub fn catmull_rom(p0: &Self, p1: &Self, p2: &Self, p3: &Self, t: f32) -> Self {
        ...
        Self {
            ...
            is_above_other_track: p1.is_above_other_track || (t > 0.5 && p2.is_above_other_track),
        }
    }
}
